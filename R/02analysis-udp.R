...
# 3. Data clean ----------------------------------------------------------------------
udp <- data %>%
  filter(university == "UDP" & rut !="")

names(udp)

# Use R -------------------------------------------------------------------
sjPlot::plot_frq(udp, use_r, type = "bar", geom.colors = "#1a9875", show.n = F)

# Install R ---------------------------------------------------------------
sjPlot::plot_frq(udp, instalation_r, type = "bar", geom.colors = "#1a9875", show.n = F)
